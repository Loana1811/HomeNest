    ...
    <div class="container mt-4">
        <div class="contract-container">
            ...
            <div class="text-center mt-4">
                ...
                <a href="contracts/generatePdf?id=${contract.contractId}" class="btn btn-teal ms-2" target="_blank">View PDF</a>
                <a href="Contracts" class="btn btn-secondary ms-2">Back</a>
            </div>
